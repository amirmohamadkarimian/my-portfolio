...
export default function Hero() {
  ...
  return (
    ...
    >
      ...
      {/* Main content */}
      <div className="section-container relative z-10 w-full pt-14 pb-28 sm:pt-16 sm:pb-24 lg:py-16">
        <div
          className={`flex flex-col ${isRTL ? "lg:flex-row-reverse" : "lg:flex-row"} items-center gap-12 lg:gap-20`}
        >
          {/* Photo */}
          <div className="flex-shrink-0 order-first lg:order-none lg:-translate-y-6 lg:translate-y-0">
          ...
          >
            ...
            >
              <span className={`inline-flex items-center bg-accent/10 border border-accent/30 text-accent ${isRTL ? "font-sans" : "font-mono"} text-sm px-4 py-2 rounded-full`}>
                {t.hero.role}
              </span>
            </div>
